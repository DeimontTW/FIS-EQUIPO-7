# Bitácora del Sprint 5 (Presencial): 4/11/2025 - 11/11/2025
...
* Rediseñar el mapa 2D
* Mejorar la vista Street View
* Diseñar la interfaz del mapa virtual en Framer
* Crear Personas y Flows
* Hacer correcciónes de la documentación y organizar el repositorio
...
* Crear la función de buscador de puntos de interés en Framer
* Crear la función de notificación funcional en Framer
* Hacer el flujo de navegación 2D funcional
* Hacer flujo de navegación Street View funcional
* Documentar las pruebas de usuario (Descripción, Tipo de Usuario, Escenario y Flujo Positivo)
...
* Todos los objetivos de este sprint se lograron completar en tiempo y forma, siguiendo con la planeación actual dictada.
